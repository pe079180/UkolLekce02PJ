...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HotelRoom room01 = new HotelRoom(1, 1, BigDecimal.valueOf(1000), YesNo.YES, YesNo.YES);
        HotelRoom room02 = new HotelRoom(2, 1, BigDecimal.valueOf(1000), YesNo.YES, YesNo.YES);
        HotelRoom room03 = new HotelRoom(3, 3, BigDecimal.valueOf(2400), YesNo.NO, YesNo.YES);
